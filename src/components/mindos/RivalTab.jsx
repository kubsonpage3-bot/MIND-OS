              ...
              return (
                <tr style={{ borderBottom: "1px solid var(--habit-border)" }}>
                  ...
                  <td className="px-4 py-2 text-center">
                    <span style={{ fontFamily: "'Press Start 2P'", fontSize: 9, fontWeight: pWins ? 700 : 400, color: pWins ? "#1ca830" : "rgba(100,116,139,0.5)" }}>
                      {playerHoursWeek.toFixed(1)}
                    </span>
                    {!pWins && <span style={{ fontFamily: "'Nunito'", fontSize: 9, color: "#ef4444", marginLeft: 2 }}>(-{hourDiff}h)</span>}
                  </td>
                  <td className="px-4 py-2 text-center">
                    <span style={{ fontFamily: "'Press Start 2P'", fontSize: 9, fontWeight: !pWins ? 700 : 400, color: !pWins ? "#ef4444" : "rgba(100,116,139,0.5)" }}>
            ...
            {(() => {
              ...
              return (
                <tr style={{ borderBottom: "1px solid #f0eef8" }}>
                  ...
                  <td className="px-4 py-2 text-center" style={{ fontFamily: "'Press Start 2P'", fontSize: 9, fontWeight: 700, color: pWins ? "#1ca830" : "#f74e52" }}>
            ...
            {(() => {
              ...
              return (
                <tr>
                  ...
                  <td className="px-4 py-2 text-center">
                    <span style={{ fontFamily: "'Press Start 2P'", fontSize: 9, fontWeight: 700, color: !pWins ? "#1ca830" : "#f74e52" }}>
