    ...
    <div className="space-y-1.5 group">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          />
          <span style={{ fontFamily: "'Press Start 2P'", fontSize: 9, color: colors.text }}>
            {config.abbr}
          </span>
        ...
        <div className="relative flex items-center gap-2">
          ...
          <AnimatePresence>
            {delta && (
              <motion.span
                ...
                style={{ fontFamily: "'Press Start 2P'", fontSize: 7, color: "#22c55e", whiteSpace: "nowrap", textShadow: "0 0 8px #22c55e55" }}
              >
                {delta}
              </motion.span>
            )}
          ...
          <motion.span
            style={{ fontFamily: "'Press Start 2P'", fontSize: 9, color: colors.text }}
