...
function PixelBar({ pct, fillColor, glowColor, label, value }) {
  return (
    <div className="flex items-center gap-1.5 md:gap-2">
      <span style={{ fontFamily: "'Press Start 2P'", fontSize: 6, color: fillColor, minWidth: 16 }}>{label}</span>
      ...
      <span style={{ fontFamily: "'Press Start 2P'", fontSize: 5.5, color: "#878190", minWidth: 36, textAlign: "right" }}>{value}</span>
    </div>
  );
}
