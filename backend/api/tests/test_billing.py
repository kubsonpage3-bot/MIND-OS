...
from api.models import UserProfile, User, CalendarEvent
...
def non_premium_user():
    user = User.objects.create_user(username="freeuser", email="free@example.com", password="password")
    profile = UserProfile.objects.get(user=user)
    return user, profile

@pytest.fixture
def premium_user():
    user = User.objects.create_user(username="premiumuser", email="premium@example.com", password="password")
    profile = UserProfile.objects.get(user=user)
