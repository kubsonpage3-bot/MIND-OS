...
OUT_DIRS = [
    "c:/coder/mind-os-growth/backend/static/items",
    "c:/coder/mind-os-growth/frontend/public/static/items",
]
    ...
    for filepath in files:
        ...
        try:
            final_img = process_image(
                filepath, tolerance=15
            )  # Using 15 to catch compression artifacts near black
            for out_dir in OUT_DIRS:
