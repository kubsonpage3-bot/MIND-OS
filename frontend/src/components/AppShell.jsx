  ...
  return (
    ...
    >
      ...
      >
        ...
        {activeApp === "life" && (
          <button
            className="md:hidden fixed z-30 flex items-center justify-center rounded-xl transition-transform active:scale-90"
            style={{
              top: "calc(env(safe-area-inset-top, 0px) + 12px)",
              left: "calc(env(safe-area-inset-left, 0px) + 12px)",
              width: 38,
              height: 38,
              background: "var(--habit-panel, rgba(20, 16, 35, 0.85))",
