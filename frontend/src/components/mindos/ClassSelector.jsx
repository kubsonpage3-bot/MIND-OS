            ...
            >
              ...
              <div className="flex justify-center mb-1 relative h-20">
                <motion.img
                  ...
                  alt={t(`rpgData.classes.${cls.id}.name`, cls.name)}
              ...
              <div className="font-mono text-xs font-bold flex items-center justify-between" style={{ color: cls.color }}>
                <span>{t(`rpgData.classes.${cls.id}.name`, cls.name)}</span>
                {isLocked && (
              ...
              <div className="text-[10px] font-mono text-muted-foreground/50 italic leading-relaxed line-clamp-2">"{t(`rpgData.classes.${cls.id}.lore`, cls.lore)}"</div>
