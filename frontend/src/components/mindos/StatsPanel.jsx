  ...
  const cards = [
    {
      ...
      label: "Day Streak",
      color: "#ff8800",
      valueStyle: { fontFamily: "'Press Start 2P'", fontSize: "1.4rem", color: "#ff8800" },
    },
    {
      icon: "⭐",
      value: weeklyXP,
      label: "Weekly XP",
      color: "#7B61FF",
      valueStyle: { fontFamily: "'Press Start 2P'", fontSize: "1.4rem", color: "#7B61FF" },
      bar: true,
      barPct: xpPct,
      barColor: "#7B61FF",
    },
    {
      ...
      label: "Cogn. ROI",
      color: roiColor,
      valueStyle: { fontFamily: "'Press Start 2P'", fontSize: "1.4rem", color: roiColor },
    },
    {
      icon: "🏆",
      value: level.title,
