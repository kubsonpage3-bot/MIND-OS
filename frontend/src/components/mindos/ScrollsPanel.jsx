...
export const SCROLLS = [
  { id: "misted_wanderer", rank: "E", name: "Misted Wanderer", scrollName: "Scroll of the Misted Wanderer", quote: "\"You cannot find what you cannot see.\"", price: 50, boss: "Misted Wanderer", bossHP: 500, color: "#94a3b8", daysLimit: 7, reward: { gold: 100, xp: 12, mp: 10, sp: 3 }, uniqueItem: { id: "wanderers_hood", label: "Wanderer's Hood", slot: "headware", effect: "+2% gold from Habits", tier: "Unique" } },
  { id: "nameless_bones", rank: "E", name: "Nameless Bones", scrollName: "Scroll of the Nameless Bones", quote: "\"Even dust remembers what it was.\"", price: 60, boss: "Nameless Skeleton", bossHP: 600, color: "#94a3b8", daysLimit: 7, reward: { gold: 120, xp: 15, mp: 10, sp: 3 }, uniqueItem: { id: "bone_bracelet", label: "Bone Bracelet", slot: "ring1", effect: "+2% XP from Dailies", tier: "Unique" } },
  { id: "herald_jackal", rank: "D", name: "Jackal's Howl", scrollName: "Scroll of the Jackal's Howl", quote: "\"I herald only one thing — your end.\"", price: 120, boss: "Herald Jackal", bossHP: 1500, color: "#22c55e", daysLimit: 7, reward: { gold: 250, xp: 35, mp: 15, sp: 5 }, uniqueItem: { id: "heralds_fang", label: "Herald's Fang", slot: "neural_link", effect: "+3% XP from Exercise tasks", tier: "Unique" } },
  { id: "ink_warden", rank: "D", name: "Ink Mark", scrollName: "Scroll of the Ink Mark", quote: "\"Every word written is a chain forged.\"", price: 130, boss: "Ink Warden", bossHP: 1800, color: "#22c55e", daysLimit: 7, reward: { gold: 280, xp: 45, mp: 15, sp: 5 }, uniqueItem: { id: "wardens_quill", label: "Warden's Quill", slot: "offhand", effect: "+3% XP from Study tasks", tier: "Unique" } },
  { id: "abyssal_bellringer", rank: "C", name: "Echoing Bell", scrollName: "Scroll of the Echoing Bell", quote: "\"The toll rings for you alone.\"", price: 230, boss: "Abyssal Bellringer", bossHP: 3500, color: "#3b82f6", daysLimit: 14, reward: { gold: 500, xp: 75, mp: 20, sp: 8 }, uniqueItem: { id: "echo_bell", label: "Echo Bell", slot: "offhand", effect: "+4% Focus stat gain", tier: "Unique" } },
  { id: "frost_executioner", rank: "C", name: "Bloodfrost", scrollName: "Scroll of Bloodfrost", quote: "\"Cold doesn't kill. Hesitation does.\"", price: 250, boss: "Frost Executioner", bossHP: 4000, color: "#3b82f6", daysLimit: 14, reward: { gold: 550, xp: 90, mp: 20, sp: 8 }, uniqueItem: { id: "frostbite_blade", label: "Frostbite Blade", slot: "arms", effect: "+4% damage to bosses", tier: "Unique" } },
  { id: "weaving_shade", rank: "C", name: "Spinning Silk", scrollName: "Scroll of Spinning Silk", quote: "\"Every thread is a trap I've already set.\"", price: 210, boss: "Weaving Shade", bossHP: 3200, color: "#3b82f6", daysLimit: 14, reward: { gold: 450, xp: 70, mp: 20, sp: 8 }, uniqueItem: { id: "silk_mantle", label: "Silk-Woven Mantle", slot: "core", effect: "−5% HP loss on missed daily", tier: "Unique" } },
  { id: "ember_smith", rank: "B", name: "Forge Wrath", scrollName: "Scroll of Forge Wrath", quote: "\"I forge weapons. You are merely the ore.\"", price: 400, boss: "Ember Smith", bossHP: 8000, color: "#9333ea", daysLimit: 14, reward: { gold: 900, xp: 150, mp: 30, sp: 12 }, uniqueItem: { id: "ember_gauntlet", label: "Ember Gauntlet", slot: "arms", effect: "+5% gold from To-Dos", tier: "Unique" } },
  { id: "sanctuary_weeper", rank: "B", name: "Sanctuary's Tear", scrollName: "Scroll of the Sanctuary's Tear", quote: "\"I weep not for you, but for what I must do.\"", price: 450, boss: "Sanctuary Weeper", bossHP: 9000, color: "#9333ea", daysLimit: 14, reward: { gold: 1000, xp: 165, mp: 30, sp: 12 }, uniqueItem: { id: "glass_tear", label: "Glass Tear", slot: "neural_link", effect: "+5 HP on a perfect day", tier: "Unique" } },
  { id: "shallow_leviathan", rank: "B", name: "Black Tide", scrollName: "Scroll of the Black Tide", quote: "\"The ocean does not drown — it invites.\"", price: 500, boss: "Shallow Leviathan", bossHP: 10000, color: "#9333ea", daysLimit: 14, reward: { gold: 1100, xp: 180, mp: 30, sp: 12 }, uniqueItem: { id: "leviathan_scale", label: "Leviathan Scale", slot: "core", effect: "+5% MP regen", tier: "Unique" } },
  { id: "faceless_king", rank: "A", name: "Ashen Name", scrollName: "Scroll of the Ashen Name", quote: "\"I have no face because I am everyone's fear.\"", price: 800, boss: "Faceless King", bossHP: 20000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2000, xp: 350, mp: 50, sp: 18 }, uniqueItem: { id: "crown_of_ash", label: "Crown of Ash", slot: "headware", effect: "+8% XP from all tasks", tier: "Unique" } },
  { id: "ore_golem", rank: "A", name: "Mine's Groan", scrollName: "Scroll of the Mine's Groan", quote: "\"The mountain does not fall. It buries.\"", price: 900, boss: "Ore Golem", bossHP: 22000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2300, xp: 400, mp: 50, sp: 18 }, uniqueItem: { id: "golems_grip", label: "Golem's Grip", slot: "arms", effect: "+8% gold from Habits", tier: "Unique" } },
  { id: "wounded_moon", rank: "A", name: "Lunar Scar", scrollName: "Scroll of the Lunar Scar", quote: "\"Even a wound becomes a crown if you survive it.\"", price: 1000, boss: "Wounded Moon", bossHP: 25000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2600, xp: 450, mp: 50, sp: 18 }, uniqueItem: { id: "scar_shard", label: "Scar Shard", slot: "ring2", effect: "+8% damage to bosses", tier: "Unique" } },
  { id: "choir_forgotten", rank: "S", name: "Forgotten Choir", scrollName: "Scroll of the Forgotten Choir", quote: "\"We sing the names of those erased by time.\"", price: 1800, boss: "Choir of the Forgotten", bossHP: 60000, color: "#f0c040", daysLimit: 30, reward: { gold: 4500, xp: 750, mp: 80, sp: 28 }, uniqueItem: { id: "forgotten_score", label: "Forgotten Score", slot: "offhand", effect: "+10% to one domain's stat ceiling", tier: "Unique" } },
  { id: "bottomless_miser", rank: "S", name: "Abyssal Greed", scrollName: "Scroll of Abyssal Greed", quote: "\"There is never enough. Not gold. Not time. Not you.\"", price: 2000, boss: "Bottomless Miser", bossHP: 70000, color: "#f0c040", daysLimit: 30, reward: { gold: 5500, xp: 850, mp: 80, sp: 28 }, uniqueItem: { id: "abyssal_purse", label: "Abyssal Purse", slot: "ring2", effect: "+12% gold from all sources", tier: "Unique" } },
  { id: "winter_thorn", rank: "S", name: "Winter's Thorn", scrollName: "Scroll of Winter's Thorn", quote: "\"Beauty and ruin wear the same face.\"", price: 2400, boss: "Winter Thorn", bossHP: 80000, color: "#f0c040", daysLimit: 30, reward: { gold: 6500, xp: 1000, mp: 80, sp: 28 }, uniqueItem: { id: "winter_plate", label: "Winter Plate", slot: "core", effect: "immune to 1 missed daily/week", tier: "Unique" } },
  { id: "king_ashen_throne", rank: "SS", name: "Ashen Throne", scrollName: "Scroll of the Ashen Throne", quote: "\"Every throne is built on someone's grave. Yours will be no different.\"", price: 4000, boss: "King of the Ashen Throne", bossHP: 180000, color: "#ff4444", daysLimit: 30, reward: { gold: 10000, xp: 1400, mp: 120, sp: 45 }, uniqueItem: { id: "throne_seal", label: "Throne Seal", slot: "ring1", effect: "+15% Power Score", tier: "Unique" } },
  { id: "eclipse_warden", rank: "SS", name: "Eclipse Eye", scrollName: "Scroll of the Eclipse Eye", quote: "\"I do not block the light. I consume it.\"", price: 4500, boss: "Eclipse Warden", bossHP: 200000, color: "#ff4444", daysLimit: 30, reward: { gold: 12000, xp: 1600, mp: 120, sp: 45 }, uniqueItem: { id: "eclipse_eye", label: "Eclipse Eye", slot: "neural_link", effect: "unlocks an extra ally slot", tier: "Unique" } },
  { id: "nameless_god", rank: "SSS", name: "Nameless God", scrollName: "Scroll of the Nameless God", quote: "\"I was worshipped before language existed. I will remain after it ends.\"", price: 8000, boss: "Nameless Machine-God", bossHP: 600000, color: "#ff00ff", daysLimit: 90, reward: { gold: 20000, xp: 2400, mp: 200, sp: 75 }, uniqueItem: { id: "mask_nameless", label: "Mask of the Nameless", slot: "headware", effect: "+25% boss rewards, permanently", tier: "Unique" } },
  { id: "final_dusk", rank: "SSS", name: "Final Dusk", scrollName: "Scroll of the Final Dusk", quote: "\"This is not the end of the world. It is the end of yours.\"", price: 9000, boss: "The Final Dusk", bossHP: 700000, color: "#ff00ff", daysLimit: 90, reward: { gold: 24000, xp: 2800, mp: 200, sp: 75 }, uniqueItem: { id: "blade_final_dusk", label: "Blade of the Final Dusk", slot: "arms", effect: "doubles damage against all bosses", tier: "Unique" } },
];
              ...
              {scrolls.map(scroll => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Boss image */}
                    <motion.div
                      className="mx-auto shrink-0 relative mb-2"
                      animate={isActive ? { y: [0, -3, 0] } : {}}
                      transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}
                    >
                      <div className="rounded-lg overflow-hidden flex items-center justify-center mx-auto" style={{ width: 64, height: 64, border: `2px solid ${color}50`, boxShadow: isActive ? `0 0 14px ${color}60` : `0 0 6px ${color}30` }}>
                        <OptimizedImage
                      ...
                      {/* Rank badge on image */}
                      <div className="absolute -top-1.5 -left-1.5 w-5 h-5 rounded-full flex items-center justify-center text-[8px] font-mono font-black"
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-start">
                      <div className="font-mono text-[11px] font-black tracking-wide truncate px-1" style={{ color: isActive ? color : isDefeated ? "#22c55e" : "#e2e0ff" }}>
                        {String(t(`scrolls.items.${scroll.id}.scrollName`, scroll.scrollName))}
                      </div>
                      <div className="font-mono text-[9px] text-muted-foreground/60 mt-0.5 truncate px-1">{String(t(`scrolls.items.${scroll.id}.boss`, scroll.boss))}</div>
                    </div>

                    {/* Bottom row */}
                    <div className="mt-3 flex flex-col gap-1 w-full shrink-0">
                      {isActive && (
                        <div className="text-[10px] font-mono text-red-400 font-bold mb-1">{t('scrolls.active_dashboard')}</div>
                      )}
                      ...
                      {!rankUnlocked && !isActive && !isDefeated && (
                        <span className="text-[9px] font-mono text-muted-foreground/30">{t('scrolls.need_rank', { rank })}</span>
                      )}
                      {isDefeated && (
                        <span className="text-[10px] font-mono text-green-400 font-bold">{t('scrolls.defeated')}</span>
                      )}
                    </div>
                  </GameCard>
                );
