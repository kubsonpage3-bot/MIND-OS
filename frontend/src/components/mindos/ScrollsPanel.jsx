...
export const SCROLLS = [
  ...
  { id: "faceless_king", rank: "A", name: "Ashen Name", scrollName: "Scroll of the Ashen Name", quote: "\"I have no face because I am everyone's fear.\"", price: 800, boss: "Faceless King", bossHP: 20000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2000, xp: 240, mp: 50, sp: 18 }, uniqueItem: { id: "crown_of_ash", label: "Crown of Ash", slot: "headware", effect: "+8% XP from all tasks", tier: "Unique" } },
  { id: "ore_golem", rank: "A", name: "Mine's Groan", scrollName: "Scroll of the Mine's Groan", quote: "\"The mountain does not fall. It buries.\"", price: 900, boss: "Ore Golem", bossHP: 22000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2300, xp: 270, mp: 50, sp: 18 }, uniqueItem: { id: "golems_grip", label: "Golem's Grip", slot: "arms", effect: "+8% gold from Habits", tier: "Unique" } },
  { id: "wounded_moon", rank: "A", name: "Lunar Scar", scrollName: "Scroll of the Lunar Scar", quote: "\"Even a wound becomes a crown if you survive it.\"", price: 1000, boss: "Wounded Moon", bossHP: 25000, color: "#f59e0b", daysLimit: 30, reward: { gold: 2600, xp: 300, mp: 50, sp: 18 }, uniqueItem: { id: "scar_shard", label: "Scar Shard", slot: "ring2", effect: "+8% damage to bosses", tier: "Unique" } },
  { id: "choir_forgotten", rank: "S", name: "Forgotten Choir", scrollName: "Scroll of the Forgotten Choir", quote: "\"We sing the names of those erased by time.\"", price: 1800, boss: "Choir of the Forgotten", bossHP: 60000, color: "#f0c040", daysLimit: 30, reward: { gold: 4500, xp: 360, mp: 80, sp: 28 }, uniqueItem: { id: "forgotten_score", label: "Forgotten Score", slot: "offhand", effect: "+10% to one domain's stat ceiling", tier: "Unique" } },
  { id: "bottomless_miser", rank: "S", name: "Abyssal Greed", scrollName: "Scroll of Abyssal Greed", quote: "\"There is never enough. Not gold. Not time. Not you.\"", price: 2000, boss: "Bottomless Miser", bossHP: 70000, color: "#f0c040", daysLimit: 30, reward: { gold: 5500, xp: 400, mp: 80, sp: 28 }, uniqueItem: { id: "abyssal_purse", label: "Abyssal Purse", slot: "ring2", effect: "+12% gold from all sources", tier: "Unique" } },
  { id: "winter_thorn", rank: "S", name: "Winter's Thorn", scrollName: "Scroll of Winter's Thorn", quote: "\"Beauty and ruin wear the same face.\"", price: 2400, boss: "Winter Thorn", bossHP: 80000, color: "#f0c040", daysLimit: 30, reward: { gold: 6500, xp: 450, mp: 80, sp: 28 }, uniqueItem: { id: "winter_plate", label: "Winter Plate", slot: "core", effect: "immune to 1 missed daily/week", tier: "Unique" } },
  { id: "king_ashen_throne", rank: "SS", name: "Ashen Throne", scrollName: "Scroll of the Ashen Throne", quote: "\"Every throne is built on someone's grave. Yours will be no different.\"", price: 4000, boss: "King of the Ashen Throne", bossHP: 180000, color: "#ff4444", daysLimit: 30, reward: { gold: 10000, xp: 550, mp: 120, sp: 45 }, uniqueItem: { id: "throne_seal", label: "Throne Seal", slot: "ring1", effect: "+15% Power Score", tier: "Unique" } },
  { id: "eclipse_warden", rank: "SS", name: "Eclipse Eye", scrollName: "Scroll of the Eclipse Eye", quote: "\"I do not block the light. I consume it.\"", price: 4500, boss: "Eclipse Warden", bossHP: 200000, color: "#ff4444", daysLimit: 30, reward: { gold: 12000, xp: 650, mp: 120, sp: 45 }, uniqueItem: { id: "eclipse_eye", label: "Eclipse Eye", slot: "neural_link", effect: "unlocks an extra ally slot", tier: "Unique" } },
  { id: "nameless_god", rank: "SSS", name: "Nameless God", scrollName: "Scroll of the Nameless God", quote: "\"I was worshipped before language existed. I will remain after it ends.\"", price: 8000, boss: "Nameless Machine-God", bossHP: 600000, color: "#ff00ff", daysLimit: 90, reward: { gold: 20000, xp: 850, mp: 200, sp: 75 }, uniqueItem: { id: "mask_nameless", label: "Mask of the Nameless", slot: "headware", effect: "+25% boss rewards, permanently", tier: "Unique" } },
  { id: "final_dusk", rank: "SSS", name: "Final Dusk", scrollName: "Scroll of the Final Dusk", quote: "\"This is not the end of the world. It is the end of yours.\"", price: 9000, boss: "The Final Dusk", bossHP: 700000, color: "#ff00ff", daysLimit: 90, reward: { gold: 24000, xp: 1000, mp: 200, sp: 75 }, uniqueItem: { id: "blade_final_dusk", label: "Blade of the Final Dusk", slot: "arms", effect: "doubles damage against all bosses", tier: "Unique" } },
];
