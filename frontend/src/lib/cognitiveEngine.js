...
export const ACTIVITIES = {
  mathematics: {
    ...
    coefficients: { gf: 0.160, ps: 0.080, gc: 0.020, vm: 0 },
  ...
  physics: {
    ...
    coefficients: { gf: 0.140, ps: 0.100, gc: 0.020, vm: 0 },
  ...
  history: {
    ...
    coefficients: { gf: 0.020, ps: 0, gc: 0.180, vm: 0.040 },
  ...
  english: {
    ...
    coefficients: { gf: 0, ps: 0.040, gc: 0.140, vm: 0.200 },
  ...
  philosophy: {
    ...
    coefficients: { gf: 0.040, ps: 0, gc: 0.160, vm: 0.080 },
  ...
  vocabulary: {
    ...
    coefficients: { gf: 0, ps: 0, gc: 0.100, vm: 0.240 },
    flavorText: "Vm +0.24 — Lexical network densified",
    xpPerHour: 25,
  },
  chess: {
    label: "Chess / Logic",
    ...
    coefficients: { gf: 0.180, ps: 0.120, gc: 0, vm: 0 },
  ...
  coding: {
    ...
    coefficients: { gf: 0.140, ps: 0.160, gc: 0.020, vm: 0 },
  ...
  creative_answers: {
    ...
    coefficients: { gf: 0.030, gc: 0.020, vm: 0.016, ps: 0.010 },
  ...
  exercise: {
    ...
    coefficients: { gf: 0.040, ps: 0.100, gc: 0, vm: 0 },
  ...
  prayer: {
    ...
    coefficients: { gf: 0, ps: 0, gc: 0.120, vm: 0.120 },
  ...
  running: {
    ...
    coefficients: { gf: 0.080, ps: 0.100, gc: 0, vm: 0 },
  ...
  reading: {
    ...
    coefficients: { gf: 0.020, ps: 0, gc: 0.140, vm: 0.100 },
  ...
  german: {
    ...
    coefficients: { gf: 0, ps: 0.060, gc: 0.120, vm: 0.140 },
