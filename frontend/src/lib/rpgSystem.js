...
export const CLASS_SPRITES = {
  architect: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/7958b621c_characters2.png",
  ascetic:   "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/303411c1f_characters3.png",
  linguist:  "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/eb9d93154_characters4.png",
  warlord:   "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/f5c789146_characters1.png",
};
...
export const ALLIES = [
  {
    ...
    color: "#00e5ff",
    rank: "B",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/bbc84a335_allyes1.jpg",
    recruitCost: 1200,
  ...
  },
  {
    ...
    color: "#ff88cc",
    rank: "C",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/b6ca653d8_allyes2.jpg",
    recruitCost: 800,
  ...
  },
  {
    ...
    color: "#7c3aff",
    rank: "A",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/4d3be463a_allyes3.jpg",
    recruitCost: 2500,
  ...
  },
  {
    ...
    color: "#4488ff",
    rank: "C",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/4794d3fbb_allyes4.jpg",
    recruitCost: 900,
  ...
  },
  {
    ...
    color: "#ff6699",
    rank: "B",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/a0f17735e_allyes5.jpg",
    recruitCost: 1500,
  ...
  },
  {
    ...
    color: "#cc44ff",
    rank: "A",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/940147528_allyes6.jpg",
    recruitCost: 3000,
  ...
  },
  {
    ...
    color: "#d4a0ff",
    rank: "S",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/03af8fc43_allyes7.jpg",
    recruitCost: 6000,
  ...
  },
  {
    ...
    color: "#00ffbb",
    rank: "B",
    image: "https://media.base44.com/images/public/69b9b825affa4271ca0d1fd9/a05ba9764_allyes8.jpg",
    recruitCost: 1800,
...
export const MUTATORS = [
  // ── AMPLIFIERS ──
  { id: "bloodwork", name: "BLOODWORK", icon: M_ICONS.fire, cost: 600, cat: "amplifier", toggle: false, durationDays: null, desc: "Science sessions give +20% Rank XP. Other subjects give -5%.", synergy: "tunnel_vision" },
  { id: "monks_path", name: "MONK'S PATH", icon: M_ICONS.spirit, cost: 700, cat: "amplifier", toggle: false, durationDays: null, desc: "Prayer/Meditation +40% Rank XP. Streak log gives +2 XP instead of +1.", synergy: "ascetic_loop" },
  { id: "iron_routine", name: "IRON ROUTINE", icon: M_ICONS.muscle, cost: 800, cat: "amplifier", toggle: false, durationDays: null, desc: "Exercise/Running +25% Rank XP. Miss a daily → lose bonus for 24h.", synergy: null },
  { id: "lexicon", name: "LEXICON", icon: M_ICONS.book, cost: 600, cat: "amplifier", toggle: false, durationDays: null, desc: "Language sessions +20% Rank XP. +0.01 Gc per session.", synergy: "echo" },
  { id: "night_owl", name: "NIGHT OWL", icon: M_ICONS.moon, cost: 500, cat: "amplifier", toggle: false, durationDays: null, desc: "Sessions after 21:00 give +30% Rank XP. Before 09:00: -10%.", synergy: null, conflicts: ["early_riser"] },
  { id: "early_riser", name: "EARLY RISER", icon: M_ICONS.sun, cost: 500, cat: "amplifier", toggle: false, durationDays: null, desc: "Sessions before 09:00 give +30% Rank XP. After 21:00: -10%.", synergy: null, conflicts: ["night_owl"] },
  { id: "tunnel_vision", name: "TUNNEL VISION", icon: M_ICONS.eye, cost: 900, cat: "amplifier", toggle: false, durationDays: null, desc: "Log ONLY one subject/day: +50% Rank XP. Log 2+: bonus lost.", synergy: "bloodwork" },
  // ── ECONOMY ──
  { id: "loan_shark", name: "LOAN SHARK", icon: M_ICONS.coin, cost: 400, cat: "economy", toggle: false, durationDays: null, desc: "+40% Gold from tasks. Every midnight: lose 30G.", synergy: "compound" },
  { id: "compound", name: "COMPOUND", icon: M_ICONS.bank, cost: 1000, cat: "economy", toggle: false, durationDays: null, desc: "Every 100G you own generates +1G/day passively.", synergy: "loan_shark" },
  ...
  // ── CHALLENGE ──
  { id: "diversity_lock", name: "DIVERSITY LOCK", icon: M_ICONS.eye, cost: 500, cat: "challenge", toggle: false, durationDays: 30, desc: "Cannot log same subject two sessions in a row. Reward: +20% Rank XP for 30d.", synergy: null },
  { id: "silence", name: "SILENCE", icon: M_ICONS.clock, cost: 400, cat: "challenge", toggle: false, durationDays: 2, desc: "All skills disabled 48h. After: all cooldowns → 0.", synergy: null },
  { id: "ironman", name: "IRONMAN", icon: M_ICONS.skull, cost: 3000, cat: "challenge", toggle: false, durationDays: null, permanent_lock: true, desc: "HP hits 0 → forced prestige. In return: all Rank XP +15% forever.", synergy: null },
  { id: "glass_cannon", name: "GLASS CANNON", icon: M_ICONS.lightning, cost: 600, cat: "challenge", toggle: true, durationDays: null, desc: "Rank XP +25%. HP loss from misses +60%.", synergy: null },
  { id: "zero_hour", name: "ZERO HOUR", icon: M_ICONS.zero, cost: 1000, cat: "challenge", toggle: false, durationDays: 7, desc: "No Gold earned for 7 days. After: get back 3× everything you would've earned.", synergy: null },
  // ── SYNERGY BUILDERS ──
  { id: "catalyst", name: "CATALYST", icon: M_ICONS.atom, cost: 1500, cat: "synergy", toggle: false, durationDays: null, desc: "Each OTHER active mutator gives +8% Rank XP. Alone: useless.", synergy: null },
  { id: "echo", name: "ECHO", icon: M_ICONS.echo, cost: 1200, cat: "synergy", toggle: false, durationDays: null, desc: "Last subject logged gives double metric gains on NEXT session (diff subject).", synergy: "lexicon" },
  { id: "mirror", name: "MIRROR", icon: M_ICONS.mirror, cost: 1100, cat: "synergy", toggle: false, durationDays: null, desc: "Same domain task as last session: +15% boss damage.", synergy: "tunnel_vision" },
  { id: "resonance", name: "RESONANCE", icon: M_ICONS.resonance, cost: 1400, cat: "synergy", toggle: false, durationDays: null, desc: "If 2+ active mutators share a category: +10% to ALL their effects.", synergy: null },
  // ── WILD ──
  { id: "gambler", name: "GAMBLER", icon: M_ICONS.dice, cost: 800, cat: "wild", toggle: false, durationDays: null, desc: "Each task: 20% chance double rewards, 20% chance 0 rewards, 60% normal.", synergy: "catalyst" },
  { id: "phantom_load", name: "PHANTOM LOAD", icon: M_ICONS.ghost, cost: 700, cat: "wild", toggle: false, durationDays: null, desc: "Yesterday's hours count as +30% today for Rank XP calculation.", synergy: "momentum" },
  { id: "cursed_clock", name: "CURSED CLOCK", icon: M_ICONS.clock, cost: 900, cat: "wild", toggle: false, durationDays: null, desc: "Every idle hour (8:00–22:00): lose 2G. But +1 Rank XP per logged hour.", synergy: null },
  { id: "deja_vu", name: "DÉJÀ VU", icon: M_ICONS.swirl, cost: 1000, cat: "wild", toggle: false, durationDays: null, desc: "Same subject 3 days in a row: 3rd session +50% Rank XP. 4th day: normal.", synergy: null },
  { id: "volatile", name: "VOLATILE", icon: M_ICONS.sword_up, cost: 1300, cat: "wild", toggle: false, durationDays: null, desc: "First task each day: +100% rewards. Last (5+ tasks): +50%. Between: -10%.", synergy: null },
  { id: "weight_of_history", name: "WEIGHT OF HISTORY", icon: M_ICONS.history, cost: 1500, cat: "wild", toggle: false, durationDays: null, desc: "Lifetime hours / 100 = permanent bonus % Rank XP. At 500h: +5%. At 1000h: +10%.", synergy: null },
];
