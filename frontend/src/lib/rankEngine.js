...
export const RANKS = [
  ...
  { id: "A",   label: "ELITE",     hoursEst: "~60h",   color: "#22c55e", glow: "rgba(34,197,94,0.15)",   desc: "The Lord is my shepherd; I shall not want. — Ps. 23:1" },
  { id: "S",   label: "APEX",      hoursEst: "~100h",  color: "#3b82f6", glow: "rgba(59,130,246,0.15)",  desc: "All things work together for good to them that love God. — Rom. 8:28" },
  { id: "SS",  label: "SOVEREIGN", hoursEst: "~150h",  color: "#a855f7", glow: "rgba(168,85,247,0.15)",  desc: "I know the thoughts that I think toward you... thoughts of peace, and not of evil. — Jer. 29:11" },
