...
export const CONSUMABLE_METADATA = {
  small_heal: {
    ...
    category: 'healing',
    tier: 'E',
    effectValue: '+25% Max HP',
    duration: 'Instant',
    trigger: 'On Use',
    shortDesc: 'Restores 25% of Max Health points immediately.',
    howItWorks: 'Instantly heals your character for 25% of your Max HP (minimum 25 HP). Essential for recovering from missed habits or failed tasks.',
  },
  medium_heal: {
    code: 'medium_heal',
    category: 'healing',
    tier: 'D',
    effectValue: '+50% Max HP',
    duration: 'Instant',
    trigger: 'On Use',
    shortDesc: 'Restores 50% of Max Health points immediately.',
    howItWorks: 'Instantly heals your character for 50% of your Max HP (minimum 50 HP). A reliable mid-tier healing flask to keep you in the fight during intense study/work weeks.',
  },
  health_potion: {
    code: 'health_potion',
    category: 'healing',
    ...
    trigger: 'On Use',
    shortDesc: 'Restores 50% of Max Health points immediately.',
    howItWorks: 'Standard revitalizing potion restoring 50% of your Max HP upon consumption.',
  },
  large_heal: {
    code: 'large_heal',
    category: 'healing',
    tier: 'C',
    effectValue: '+75% Max HP',
    duration: 'Instant',
    trigger: 'On Use',
    shortDesc: 'Restores 75% of Max Health points immediately.',
    howItWorks: 'A potent high-grade brew that restores 75% of your Max HP (minimum 100 HP) in one gulp. Ideal for surviving high-penalty quest failures.',
  },
  elixir: {
    code: 'elixir',
    category: 'healing',
    tier: 'B',
    effectValue: '100% HP + 24h Shield',
    duration: '24 Hours',
    trigger: 'On Use',
    shortDesc: 'Restores HP to 100% and grants a protective shield for 24 hours.',
    howItWorks: 'The ultimate restorative draught. Instantly refills your Health to maximum and shields you from all incoming damage penalties for 24 hours.',
  },
  focus_stim: {
    code: 'focus_stim',
    category: 'cognition',
  ...
  daily_gold_rush: {
    ...
    category: 'buff',
    tier: 'C',
    effectValue: '+50% Gold Boost',
    duration: '24 Hours',
    trigger: 'All Activities',
    shortDesc: 'Grants +50% bonus Gold from all activities for 24 hours.',
    howItWorks: 'Infuses your character with economic prowess. Multiplies all Gold earned from completed tasks, habits, dailies, and pomodoros by 1.5x for 24 hours.',
  },
  focus_scroll: {
    code: 'focus_scroll',
    category: 'buff',
