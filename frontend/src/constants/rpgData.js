...
export const SKILL_TREE = {
  ...
  body: {
    ...
    nodes: [
      ...
      { id: "unbreakable", tier: 5, name: "Unbreakable", desc: "HP regenerates +3 per day passively — your body heals itself", requires: "pain_threshold", sp: 22, gold: 1500 },
      { id: "apex_predator", tier: 6, name: "APEX PREDATOR", desc: "Boss damage +30% permanently. You are the apex.", requires: "unbreakable", sp: 35, gold: 3000 },
    ],
  },
  wealth: {
  ...
  knowledge: {
    ...
    nodes: [
      ...
      { id: "cross_training", tier: 2, name: "Cross-Training", desc: "Language sessions give +30% humanities XP bonus and +0.05 flat Gf", requires: "polymath", sp: 6, gold: 250 },
      ...
      { id: "master_of_arts", tier: 4, name: "Master of Arts", desc: "Humanities subject rank thresholds reduced by 15% — reach mastery faster", requires: "encyclopedia", sp: 15, gold: 800 },
      { id: "living_library", tier: 5, name: "Living Library", desc: "Rival XP accumulation slowed by 15% — your knowledge outpaces theirs", requires: "master_of_arts", sp: 22, gold: 1500 },
      { id: "omniscience", tier: 6, name: "OMNISCIENCE", desc: "Each achievement unlocked grants +0.3 flat to all 4 cognitive metrics (Gf, Gc, Ps, Vm)", requires: "living_library", sp: 35, gold: 3000 },
    ],
  },
};
...
export const ALLIES = [
  ...
  },
  {
    ...
    color: "#6b7280",
    rank: "A",
    image: "/images/webp/ally_9.webp",
    recruitCost: 2800,
    lore: "True progress is forged in absolute resilience.",
    upgradeCosts: [1800, 3500, 6000, 12000],
    levels: [
      "Focus >= 9.0 restores +2 HP but gives -25% Gold",
      "Failed tasks trigger Shield Slam (prevents 50% HP damage, deals that damage to boss for 5 Mana)",
      "Increases Max HP by 40, but reduces Speed (SPD) by 4 permanently",
      "Failed tasks add Revenge charges (max 3); next completion consumes charges to deal +50% boss damage each",
      "Below 20% HP: immune to missed daily HP damage, double task boss damage, but disables mana regeneration"
    ],
  },
  {
    id: "lyra",
    ...
    color: "#a855f7",
    rank: "S",
    image: "/images/webp/ally_10.webp",
    recruitCost: 6000,
    lore: "She weaves strands of time to extend perfect concentration.",
    upgradeCosts: [4000, 8000, 16000, 32000],
    levels: [
      "Focus sessions >2h give +30% Rank XP, but <30m give 0 rewards",
      "Once per day: Revert a task to restore HP lost without losing XP/Gold",
      "Logging focus session forces Focus = 10.0 for first 30m, decays by 1.5 every 15m",
      "Reduces active skill cooldowns by 1h per 1.0h of logged focus sessions",
      "Once per day: Completing a Daily duplicates rewards and boss damage of next 3 completed Todos at cost of 50% current Mana"
    ],
  },
  {
    id: "meldor",
    ...
    color: "#10b981",
    rank: "B",
    image: "/images/webp/ally_11.webp",
    recruitCost: 1600,
    lore: "He turns failures and waste into hazardous mutagenic power.",
    upgradeCosts: [1000, 2000, 3200, 6500],
    levels: [
      "Completing a Todo has 10% chance to drop random ingredient but costs 2 HP",
      "Increases active mutators' effects/penalties by +25% flat (+100% and +25% flat stacked with Parasite, max 5x cap)",
      "Salvaging/selling items has a 10% chance to yield a crafting ingredient instead of gold",
      "Active mutator expiration deals 200 boss damage at cost of 15 Mana",
      "Completing a Hard task has 15% chance to duplicate item dropped, but item sales yield 0 Gold"
    ],
  },
  {
    id: "kage",
    ...
    color: "#ef4444",
    rank: "A",
    image: "/images/webp/ally_12.webp",
    recruitCost: 2600,
    lore: "He strikes from the blind spots of your habits.",
    upgradeCosts: [1600, 3200, 5500, 11000],
    levels: [
      "Critical hit damage increased to x3.0, but base critical chance is halved",
      "Completing a Todo deals +40 boss damage but yields 0 Gold",
      "Critical hits restore +8 HP/MP, but normal hits deal 1 HP damage to you",
      "When HP drops to 0: prevents death, restores 20 HP, and stuns boss for 4h (24h cooldown)",
      "5x damage to boss below 15% HP, but task failure deals 50% more damage to you"
    ],
  },
  {
    id: "zephyr",
    ...
    color: "#f59e0b",
    rank: "C",
    image: "/images/webp/ally_13.webp",
    recruitCost: 850,
    lore: "His melodies synchronize with your focus cycles.",
    upgradeCosts: [550, 1000, 1700, 3400],
    levels: [
      "Logging different focus subject gives +20% Rank XP",
      "Streak of 10+ days increases all core stats by +2",
      "Boosts all other active allies' perks by +15% (ally_stat_mult +0.15)",
      "Every 4th task completed in a day grants a free chest, but tasks 1-3 yield -15% gold",
      "Completing all active Dailies in a day deals 600 boss damage and restores full mana"
    ],
  },
  {
    id: "bran",
    ...
    color: "#84cc16",
    rank: "B",
    image: "/images/webp/ally_14.webp",
    recruitCost: 1500,
    lore: "He cobbles scrap metal into mechanical wonders.",
    upgradeCosts: [900, 1800, 3000, 6000],
    levels: [
      "+8% item drop chance on tasks, but -10% Rank XP gains",
      "Reduces gold cost of all shop items and loot chests by 15%",
      "Salvaging/selling equipment yields double gold and 20% ingredient drop chance",
      "+30% equipped gear stat bonuses, but lose 1 HP for every skill activated",
      "Opening a Loot Chest has a 12% chance to refund its Gold cost entirely"
    ],
  },
  {
    id: "vivian",
    ...
    color: "#ec4899",
    rank: "S",
    image: "/images/webp/ally_15.webp",
    recruitCost: 6000,
    lore: "She converts your vital blood into raw magical energy.",
    upgradeCosts: [4000, 8000, 15000, 30000],
    levels: [
      "Activate skills using HP instead of Mana (1 HP = 2 Mana), but disables healing from shop potions",
      "Lose 15 HP to reset a random skill cooldown (12h cooldown)",
      "Task completion heals +2 HP per 10% missing health",
      "Task completion heals you for 10% of damage dealt to the boss",
      "At exactly 1 HP: 100% critical hit chance and double XP gains"
    ],
  },
  {
    id: "rhea",
    ...
    color: "#3b82f6",
    rank: "S",
    image: "/images/webp/ally_16.webp",
    recruitCost: 6000,
    lore: "She maps space that does not exist.",
    upgradeCosts: [4000, 8000, 15000, 30000],
    levels: [
      "With active mutator: shuffles stats every hour (+20% sum)",
      "Once per day: Swap an active mutator with a random one from the pool",
      "Gravity Well: extends daily deadline by 4h (to 4 AM) but missing them deals +30% HP damage",
      "Task completion pulls boss HP down by 1.5% max HP at cost of 2 Mana",
      "Increases max active mutators limit from 3 to 4, at cost of -30 permanent Max HP"
    ],
  },
];
...
export const ACHIEVEMENTS = [
  // Consistency
  { id: "first_step", name: "First Step", cat: "consistency", color: "#f59e0b", icon: "👣", desc: "Log your first session", reward: "+50G", rarity: "common", check: (s) => s.totalSessions >= 1 },
  { id: "seven_suns", name: "Seven Suns", cat: "consistency", color: "#f59e0b", icon: "☀️", desc: "Reach a 7-day streak", reward: "+150G", rarity: "uncommon", check: (s) => s.maxStreak >= 7 },
  { id: "iron_will", name: "Iron Will", cat: "consistency", color: "#f59e0b", icon: "🔩", desc: "Reach a 30-day streak", reward: "+500G + Title", rarity: "rare", check: (s) => s.maxStreak >= 30 },
  { id: "unbroken", name: "Unbroken", cat: "consistency", color: "#f59e0b", icon: "⛓️", desc: "Reach a 100-day streak", reward: "+2000G + Title", rarity: "epic", check: (s) => s.maxStreak >= 100 },
  { id: "eternal", name: "Eternal", cat: "consistency", color: "#f59e0b", icon: "♾️", desc: "Reach a 365-day streak", reward: "+10000G + Title", rarity: "legendary", check: (s) => s.maxStreak >= 365 },
  // Combat
  { id: "first_blood", name: "First Blood", cat: "combat", color: "#ef4444", icon: "🩸", desc: "Deal 100 total boss damage", reward: "+30G", rarity: "common", check: (s) => s.totalBossDamage >= 100 },
  { id: "boss_slayer", name: "Boss Slayer", cat: "combat", color: "#ef4444", icon: "⚔️", desc: "Defeat your first boss", reward: "+200G + Title", rarity: "uncommon", check: (s) => s.bossesDefeated >= 1 },
  { id: "dragon_hunter", name: "Dragon Hunter", cat: "combat", color: "#ef4444", icon: "🐉", desc: "Defeat the Crimson Sovereign", reward: "+1000G + Title", rarity: "rare", check: (s) => s.bossesDefeated >= 4 },
  { id: "emperors_bane", name: "Emperor's Bane", cat: "combat", color: "#ef4444", icon: "👑", desc: "Defeat the Void Emperor", reward: "+5000G + Title", rarity: "epic", check: (s) => s.bossesDefeated >= 5 },
  { id: "void_walker", name: "Void Walker", cat: "combat", color: "#ef4444", icon: "🌌", desc: "Complete all 5 bosses", reward: "+10000G + Title", rarity: "legendary", check: (s) => s.bossesDefeated >= 5 },
  // Knowledge
  { id: "first_session", name: "First Session", cat: "knowledge", color: "#3b82f6", icon: "📚", desc: "Log your first TRAIN session", reward: "+30G", rarity: "common", check: (s) => s.totalSessions >= 1 },
  { id: "scholar", name: "Scholar", cat: "knowledge", color: "#3b82f6", icon: "🎓", desc: "Log 50 total sessions", reward: "+300G", rarity: "uncommon", check: (s) => s.totalSessions >= 50 },
  { id: "polymath_ach", name: "Polymath", cat: "knowledge", color: "#3b82f6", icon: "🧩", desc: "Log in 10 different subjects", reward: "+500G", rarity: "rare", check: (s) => s.uniqueSubjects >= 10 },
  { id: "master", name: "Master", cat: "knowledge", color: "#3b82f6", icon: "🏅", desc: "Reach B rank in any subject", reward: "+1000G", rarity: "epic", check: (s) => s.highestSubjectRank >= 4 },
  { id: "grandmaster", name: "Grandmaster", cat: "knowledge", color: "#3b82f6", icon: "🌟", desc: "Reach SSS rank in any subject", reward: "+5000G + Title", rarity: "legendary", check: (s) => s.highestSubjectRank >= 8 },
  // Wealth
  { id: "first_coin", name: "First Coin", cat: "wealth", color: "#f0c040", icon: "🪙", desc: "Earn your first Gold", reward: "+10G", rarity: "common", check: (s) => s.totalGoldEarned >= 1 },
  { id: "merchant", name: "Merchant", cat: "wealth", color: "#f0c040", icon: "💰", desc: "Accumulate 1000G total earned", reward: "+100G", rarity: "uncommon", check: (s) => s.totalGoldEarned >= 1000 },
  { id: "wealthy", name: "Wealthy", cat: "wealth", color: "#f0c040", icon: "💎", desc: "Accumulate 10000G total earned", reward: "+500G", rarity: "rare", check: (s) => s.totalGoldEarned >= 10000 },
  { id: "tycoon", name: "Tycoon", cat: "wealth", color: "#f0c040", icon: "🏦", desc: "Accumulate 100000G total earned", reward: "+2000G + Title", rarity: "legendary", check: (s) => s.totalGoldEarned >= 100000 },
  // Spirit
  { id: "first_prayer", name: "First Prayer", cat: "spirit", color: "#9944ff", icon: "🕊️", desc: "Log your first Prayer session", reward: "+50G", rarity: "common", check: (s) => s.prayerSessions >= 1 },
  { id: "devotion", name: "Devotion", cat: "spirit", color: "#9944ff", icon: "📿", desc: "Log 20 Prayer sessions", reward: "+300G", rarity: "uncommon", check: (s) => s.prayerSessions >= 20 },
  { id: "sanctified", name: "Sanctified", cat: "spirit", color: "#9944ff", icon: "✨", desc: "Reach S rank in Prayer", reward: "+1000G + Title", rarity: "rare", check: (s) => s.prayerRank >= 7 },
  // Combat Skill
  { id: "first_crit", name: "First Crit", cat: "skill", color: "#00e5ff", icon: "💥", desc: "Land your first critical hit", reward: "+20G", rarity: "common", check: (s) => s.totalCrits >= 1 },
  { id: "precision", name: "Precision", cat: "skill", color: "#00e5ff", icon: "🎯", desc: "Land 50 critical hits", reward: "+300G", rarity: "uncommon", check: (s) => s.totalCrits >= 50 },
  { id: "sharpshooter", name: "Sharpshooter", cat: "skill", color: "#00e5ff", icon: "🏹", desc: "Land 500 critical hits", reward: "+2000G + Title", rarity: "epic", check: (s) => s.totalCrits >= 500 },
  // Allies
  { id: "first_ally", name: "First Ally", cat: "allies", color: "#00cc88", icon: "🤝", desc: "Recruit your first ally", reward: "+100G", rarity: "common", check: (s) => s.alliesRecruited >= 1 },
  { id: "commander", name: "Commander", cat: "allies", color: "#00cc88", icon: "🎖️", desc: "Recruit 3 allies", reward: "+500G", rarity: "uncommon", check: (s) => s.alliesRecruited >= 3 },
  { id: "warlords_court", name: "Warlord's Court", cat: "allies", color: "#00cc88", icon: "⚜️", desc: "Recruit all 5 allies", reward: "+2000G + Title", rarity: "rare", check: (s) => s.alliesRecruited >= 5 },
  { id: "loyal_bonds", name: "Loyal Bonds", cat: "allies", color: "#00cc88", icon: "💜", desc: "Upgrade any ally to Lv5", reward: "+1000G", rarity: "epic", check: (s) => s.allyMaxLevel >= 5 },
  // Prestige
  { id: "reborn", name: "Reborn", cat: "prestige", color: "#ffd700", icon: "🔄", desc: "Complete your first prestige", reward: "Title: Reborn", rarity: "legendary", check: (s) => s.prestigeCount >= 1 },
  { id: "phoenix", name: "Phoenix", cat: "prestige", color: "#ffd700", icon: "🦅", desc: "Complete 3 prestiges", reward: "Title: Phoenix", rarity: "legendary", check: (s) => s.prestigeCount >= 3 },
];
...
export const MUTATORS = [
  // ── AMPLIFIERS ──
  { id: "bloodwork",  name: "BLOODWORK", icon: getMediaUrl("/static/items/bloodwork.webp"), cost: 300, cat: "amplifier", toggle: false, durationDays: null, desc: "Science sessions give +20% Rank XP. Other subjects give -5%.", synergy: "tunnel_vision" },
  { id: "monks_path",  name: "MONK'S PATH", icon: getMediaUrl("/static/items/monks_path.webp"), cost: 350, cat: "amplifier", toggle: false, durationDays: null, desc: "Prayer/Meditation +40% Rank XP. Streak log gives +2 XP instead of +1.", synergy: "ascetic_loop" },
  { id: "iron_routine",  name: "IRON ROUTINE", icon: getMediaUrl("/static/items/iron_routine.webp"), cost: 400, cat: "amplifier", toggle: false, durationDays: null, desc: "Exercise/Running +25% Rank XP. Miss a daily → lose bonus for 24h.", synergy: null },
  { id: "lexicon",  name: "LEXICON", icon: getMediaUrl("/static/items/lexicon.webp"), cost: 300, cat: "amplifier", toggle: false, durationDays: null, desc: "Language sessions +20% Rank XP. +0.01 Gc per session.", synergy: "echo" },
  { id: "night_owl",  name: "NIGHT OWL", icon: getMediaUrl("/static/items/night_owl.webp"), cost: 250, cat: "amplifier", toggle: false, durationDays: null, desc: "Sessions after 21:00 give +30% Rank XP. Before 09:00: -10%.", synergy: null, conflicts: ["early_riser"] },
  { id: "early_riser",  name: "EARLY RISER", icon: getMediaUrl("/static/items/early_riser.webp"), cost: 250, cat: "amplifier", toggle: false, durationDays: null, desc: "Sessions before 09:00 give +30% Rank XP. After 21:00: -10%.", synergy: null, conflicts: ["night_owl"] },
  { id: "tunnel_vision",  name: "TUNNEL VISION", icon: getMediaUrl("/static/items/tunnel_vision.webp"), cost: 450, cat: "amplifier", toggle: false, durationDays: null, desc: "Log ONLY one subject/day: +50% Rank XP. Log 2+: bonus lost.", synergy: "bloodwork", disabled: true },
  // ── ECONOMY ──
  { id: "loan_shark",  name: "LOAN SHARK", icon: getMediaUrl("/static/items/loan_shark.webp"), cost: 200, cat: "economy", toggle: false, durationDays: null, desc: "+40% Gold from tasks. Every midnight: lose 30G.", synergy: "compound" },
  { id: "compound",  name: "COMPOUND", icon: getMediaUrl("/static/items/compound.webp"), cost: 500, cat: "economy", toggle: false, durationDays: null, desc: "Every 100G you own generates +1G/day passively.", synergy: "loan_shark" },
  { id: "miser",  name: "MISER", icon: getMediaUrl("/static/items/miser.webp"), cost: 350, cat: "economy", toggle: true, durationDays: null, desc: "Cannot spend Gold on shop items. Each 24h without spending: +5 Rank XP.", synergy: null, disabled: true },
  { id: "tithe",  name: "TITHE", icon: getMediaUrl("/static/items/tithe.webp"), cost: 400, cat: "economy", toggle: false, durationDays: null, desc: "Each task: pay 3G or lose 5 HP. But +15% Rank XP from all tasks.", synergy: "compound" },
  // ── STREAK ──
    
  { id: "ascetic_loop",  name: "ASCETIC LOOP", icon: getMediaUrl("/static/items/ascetic_loop.webp"), cost: 450, cat: "streak", toggle: false, durationDays: null, desc: "Streak gives Rank XP: streak×0.2 per day. Break streak: lose all bonus XP.", synergy: "monks_path", disabled: true },
  { id: "double_nothing",  name: "DOUBLE OR NOTHING", icon: getMediaUrl("/static/items/double_nothing.webp"), cost: 600, cat: "streak", toggle: true, durationDays: null, desc: "Streak milestone rewards doubled. Miss 2 days in a row: streak resets to 0.", synergy: null },
  { id: "momentum",  name: "MOMENTUM", icon: getMediaUrl("/static/items/momentum.webp"), cost: 400, cat: "streak", toggle: false, durationDays: null, desc: "Each day with 1h+ logged: +2% Rank XP, stacks to +20%. Miss: resets.", synergy: "phantom_load" },
  // ── CHALLENGE ──
  { id: "diversity_lock",  name: "DIVERSITY LOCK", icon: getMediaUrl("/static/items/diversity_lock.webp"), cost: 250, cat: "challenge", toggle: false, durationDays: 30, desc: "Cannot log same subject two sessions in a row. Reward: +20% Rank XP for 30d.", synergy: null },
  { id: "silence",  name: "SILENCE", icon: getMediaUrl("/static/items/silence.webp"), cost: 200, cat: "challenge", toggle: false, durationDays: 2, desc: "All skills disabled 48h. After: all cooldowns → 0.", synergy: null },
  { id: "ironman",  name: "IRONMAN", icon: getMediaUrl("/static/items/ironman.webp"), cost: 1500, cat: "challenge", toggle: false, durationDays: null, permanent_lock: true, desc: "HP hits 0 → forced prestige. In return: all Rank XP +15% forever.", synergy: null, disabled: true },
  { id: "glass_cannon",  name: "GLASS CANNON", icon: getMediaUrl("/static/items/glass_cannon.webp"), cost: 300, cat: "challenge", toggle: true, durationDays: null, desc: "Rank XP +25%. HP loss from misses +60%.", synergy: null },
  ...
  // ── WILD ──
  { id: "gambler",  name: "GAMBLER", icon: getMediaUrl("/static/items/gambler.webp"), cost: 400, cat: "wild", toggle: false, durationDays: null, desc: "Each task: 20% chance double rewards, 20% chance 0 rewards, 60% normal.", synergy: "catalyst" },
  { id: "phantom_load",  name: "PHANTOM LOAD", icon: getMediaUrl("/static/items/phantom_load.webp"), cost: 350, cat: "wild", toggle: false, durationDays: null, desc: "Yesterday's hours count as +30% today for Rank XP calculation.", synergy: "momentum" },
  { id: "cursed_clock",  name: "CURSED CLOCK", icon: getMediaUrl("/static/items/cursed_clock.webp"), cost: 450, cat: "wild", toggle: false, durationDays: null, desc: "Every idle hour (8:00–22:00): lose 2G. But +1 Rank XP per logged hour.", synergy: null },
  { id: "deja_vu",  name: "DÉJÀ VU", icon: getMediaUrl("/static/items/deja_vu.webp"), cost: 500, cat: "wild", toggle: false, durationDays: null, desc: "Same subject 3 days in a row: 3rd session +50% Rank XP. 4th day: normal.", synergy: null },
  { id: "volatile",  name: "VOLATILE", icon: getMediaUrl("/static/items/volatile.webp"), cost: 650, cat: "wild", toggle: false, durationDays: null, desc: "First task each day: +100% rewards. Last (5+ tasks): +50%. Between: -10%.", synergy: null },
  { id: "weight_of_history",  name: "WEIGHT OF HISTORY", icon: getMediaUrl("/static/items/weight_of_history.webp"), cost: 750, cat: "wild", toggle: false, durationDays: null, desc: "Lifetime hours / 100 = permanent bonus % Rank XP. At 500h: +5%. At 1000h: +10%.", synergy: null },
  { id: "mirror_match", name: "MIRROR MATCH", icon: getMediaUrl("/static/items/mirror_match.webp"), cost: 400, cat: "synergy", toggle: false, durationDays: null, desc: "30% chance on completion to autocomplete another task of the same category for 50% reward.", synergy: null },
  { id: "alchemist", name: "ALCHEMIST", icon: getMediaUrl("/static/items/alchemist.webp"), cost: 500, cat: "economy", toggle: false, durationDays: null, desc: "At daily reset, converts all unspent Mana into Gold (1 Mana = 2 Gold).", synergy: null },
  { id: "time_dilation", name: "TIME DILATION", icon: getMediaUrl("/static/items/time_dilation.webp"), cost: 600, cat: "amplifier", toggle: false, durationDays: null, desc: "Sessions require a minimum of 2.0 hours to submit, but grant 3.0x XP and Gold.", synergy: null },
  { id: "sacrificial_altar", name: "SACRIFICIAL ALTAR", icon: getMediaUrl("/static/items/sacrificial_altar.webp"), cost: 700, cat: "wild", toggle: false, durationDays: null, desc: "Permanently delete a completed Habit/Daily (min 7d old or streak 5+) for a large reward.", synergy: null },
  { id: "twin_souls", name: "TWIN SOULS", icon: getMediaUrl("/static/items/twin_souls.webp"), cost: 450, cat: "synergy", toggle: false, durationDays: null, desc: "Directs 15% of all XP and Gold to the active ally with the lowest XP received.", synergy: null },
  { id: "inversion", name: "INVERSION", icon: getMediaUrl("/static/items/inversion.webp"), cost: 300, cat: "amplifier", toggle: false, durationDays: null, desc: "Flips focus quality: low focus yields high rewards, high focus yields low rewards.", synergy: null },
  { id: "gamblers_ledger", name: "GAMBLER'S LEDGER", icon: getMediaUrl("/static/items/gamblers_ledger.webp"), cost: 500, cat: "economy", toggle: false, durationDays: null, desc: "Gold from tasks is stored in a ledger and paid out at weekly reset with a +50% bonus.", synergy: null },
  { id: "parasite", name: "PARASITE", icon: getMediaUrl("/static/items/parasite.webp"), cost: 800, cat: "wild", toggle: false, durationDays: null, desc: "Doubles the effect of all active XP and Gold mutators (bonuses and penalties).", synergy: null },
  { id: "null_zone", name: "NULL ZONE", icon: getMediaUrl("/static/items/null_zone.webp"), cost: 400, cat: "challenge", toggle: false, durationDays: null, desc: "Fully disables XP gain, converting 100% of earned XP into Gold at 1 XP = 0.5 Gold.", synergy: null },
  { id: "chronomancer", name: "CHRONOMANCER", icon: getMediaUrl("/static/items/chronomancer.webp"), cost: 750, cat: "wild", toggle: false, durationDays: null, desc: "Banks a missed day (once every 14 days) to preserve your streak and finish tasks later.", synergy: null },
];
