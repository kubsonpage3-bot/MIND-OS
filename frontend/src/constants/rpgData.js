...
export const SKILL_TREE = {
  ...
  spirit: {
    ...
    nodes: [
      ...
      { id: "transcendent_will", tier: 5, name: "Sanctuary", desc: "Once per day, a missed login streak is protected for free — no streak shield item needed", requires: "aura_of_focus", sp: 22, gold: 1500 },
  ...
  knowledge: {
    ...
    nodes: [
      ...
      { id: "living_library", tier: 5, name: "Cross-Reference", desc: "Studying 2+ different subjects the same day grants +15% Gf/Gc/Ps/Vm gains that session", requires: "master_of_arts", sp: 22, gold: 1500 },
      { id: "omniscience", tier: 6, name: "OMNISCIENCE", desc: "Eases the growth soft-cap near your Gf/Gc/Ps/Vm ceilings by 20% — you never fully plateau", requires: "living_library", sp: 35, gold: 3000 },
    ],
  },
};
...
export const MUTATORS = [
  ...
  { id: "tunnel_vision",  name: "TUNNEL VISION", icon: getMediaUrl("/static/items/tunnel_vision.webp"), cost: 450, cat: "amplifier", toggle: false, durationDays: null, desc: "Log ONLY one subject/day: +50% Rank XP. Log 2+: bonus lost.", synergy: "bloodwork" },
  // ── ECONOMY ──
  ...
  { id: "miser",  name: "MISER", icon: getMediaUrl("/static/items/miser.webp"), cost: 350, cat: "economy", toggle: true, durationDays: null, desc: "Cannot spend Gold on shop items. Each 24h without spending: +5 Rank XP.", synergy: null },
  ...
  { id: "ascetic_loop",  name: "ASCETIC LOOP", icon: getMediaUrl("/static/items/ascetic_loop.webp"), cost: 450, cat: "streak", toggle: false, durationDays: null, desc: "Streak gives Rank XP: streak×0.2 per day. Break streak: lose all bonus XP.", synergy: "monks_path" },
  ...
  { id: "ironman",  name: "IRONMAN", icon: getMediaUrl("/static/items/ironman.webp"), cost: 1500, cat: "challenge", toggle: false, durationDays: null, permanent_lock: true, desc: "HP hits 0 → forced prestige. In return: all Rank XP +15% forever.", synergy: null },
  ...
  { id: "phantom_load",  name: "PHANTOM LOAD", icon: getMediaUrl("/static/items/phantom_load.webp"), cost: 350, cat: "wild", toggle: false, durationDays: null, desc: "Yesterday's hours count as +30% today for Rank XP calculation, capped at +60%.", synergy: "momentum" },
  ...
  { id: "alchemist", name: "ALCHEMIST", icon: getMediaUrl("/static/items/alchemist.webp"), cost: 500, cat: "economy", toggle: false, durationDays: null, desc: "At daily reset, converts unspent Mana into Gold (1 Mana = 2 Gold, up to 200 Gold/day).", synergy: null },
