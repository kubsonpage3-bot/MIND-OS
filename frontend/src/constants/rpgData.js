...
export const SKILL_TREE = {
  ...
  knowledge: {
    ...
    nodes: [
      ...
      { id: "omniscience", tier: 6, name: "OMNISCIENCE", desc: "Each boss defeated grants +0.2 flat to all 4 cognitive metrics (Gf, Gc, Ps, Vm)", requires: "living_library", sp: 35, gold: 3000 },
    ],
  },
};
