...
export const MUTATORS = [
  ...
  { id: "tunnel_vision", name: "TUNNEL VISION", icon: getMediaUrl("/static/items/tunnel_vision.webp"), cost: 900, cat: "amplifier", toggle: false, durationDays: null, desc: "Log ONLY one subject/day: +50% Rank XP. Log 2+: bonus lost.", synergy: "bloodwork", disabled: true },
  // ── ECONOMY ──
  ...
  { id: "miser", name: "MISER", icon: getMediaUrl("/static/items/miser.webp"), cost: 700, cat: "economy", toggle: true, durationDays: null, desc: "Cannot spend Gold on shop items. Each 24h without spending: +5 Rank XP.", synergy: null, disabled: true },
  ...
  { id: "ascetic_loop", name: "ASCETIC LOOP", icon: getMediaUrl("/static/items/ascetic_loop.webp"), cost: 900, cat: "streak", toggle: false, durationDays: null, desc: "Streak gives Rank XP: streak×0.2 per day. Break streak: lose all bonus XP.", synergy: "monks_path", disabled: true },
  ...
  { id: "ironman", name: "IRONMAN", icon: getMediaUrl("/static/items/ironman.webp"), cost: 3000, cat: "challenge", toggle: false, durationDays: null, permanent_lock: true, desc: "HP hits 0 → forced prestige. In return: all Rank XP +15% forever.", synergy: null, disabled: true },
